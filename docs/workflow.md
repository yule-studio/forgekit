...
| **Commit** | Conventional Commit + AI trailer | 형식 + 출처 trailer | [commits](commits.md) · [ai-attribution](ai-attribution.md) |
...
### Commit
- **Conventional Commits** 사용. AI 가 작성·보조한 커밋은 trailer 로 출처를 남긴다.
