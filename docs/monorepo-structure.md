...
| `yule_engineering.runtime.{circuit_breaker,services,subprocess_supervisor}` | `packages/runtime-primitives` (`yule_runtime_primitives`; 구 `yule_runtime` 은 compat shim) |
