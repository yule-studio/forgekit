...
| 도입 효율 검토 (외부 plugin/skill/collector/rule/workflow/tool adopt-now/collect-first/hold) | working (8점 검토+PM/tech-lead/specialist 3축+adopted≠equipped+fake adoption 차단; collect-first/hold 장착 금지) | governance artifact (`decision_lane.adoption_review`) | `examples/cockpit-qa/cockpit-qa.txt`, `test_adoption_review` |
