...
코드 SSoT —
[`agents/job_queue/pr_merge_continuation.py`](../apps/engineering-agent/src/yule_engineering/agents/job_queue/pr_merge_continuation.py),
[`agents/job_queue/pr_merge_continuation_worker.py`](../apps/engineering-agent/src/yule_engineering/agents/job_queue/pr_merge_continuation_worker.py),
[`agents/job_queue/next_slice_dispatcher.py`](../apps/engineering-agent/src/yule_engineering/agents/job_queue/next_slice_dispatcher.py),
[`runtime/coding_executor_runner.py::_pr_merge_continuation_loop`](../apps/engineering-agent/src/yule_engineering/runtime/coding_executor_runner.py).
