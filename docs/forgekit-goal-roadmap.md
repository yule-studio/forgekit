...
실행 순서(의존 기준): **GW1 ✅ → GW2-A ✅ → GW3 ✅ → GW4-A ✅ → GW6 ✅ → GW5 ✅ → GW7 ✅ → GW8 ✅** (merge-prep: [`forgekit-goal-mergeprep.md`](forgekit-goal-mergeprep.md)). 남은 seam: GW4-B 실행 bridge, ~~in-console approve/deny UI~~ ✅(`/goal awaiting|approve|deny`, wave-2 gw3), GW2-B trailer→identity.
