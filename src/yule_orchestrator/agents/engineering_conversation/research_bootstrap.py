...
from yule_orchestrator.agents.messaging.dispatcher import TaskType
...
def _maybe_run_auto_collect(
    *,
    ...
    # canonical predicate.
    try:
        from yule_orchestrator.agents.routing import is_non_actionable_prompt as _is_blocked
