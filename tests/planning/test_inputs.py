...
from yule_integrations.calendar.errors import build_calendar_error
from yule_integrations.github.issues import GitHubIssueError
from yule_planning.inputs import collect_planning_inputs


class PlanningInputsTestCase(unittest.TestCase):
    @patch("yule_planning.inputs.list_calendar_state_records")
    ...
    @patch("yule_planning.inputs.list_naver_calendar_items")
    @patch("yule_planning.inputs.list_calendar_state_records")
    ...
    @patch("yule_planning.inputs.list_open_issues")
