...
from yule_discord.bot import _extract_conversation_prompt, _should_handle_message
from yule_discord.runtime.checkpoint_state import (
    CHECKPOINT_RESPONSE_STATUS_DONE,
    CHECKPOINT_RESPONSE_STATUS_SKIPPED,
    CheckpointPendingResponse,
)
from yule_discord.conversation import (
    build_conversation_response,
    build_conversation_response_envelope,
    detect_conversation_intent,
)
from yule_planning.ollama_config import OllamaConversationConfig
...
class DiscordConversationTestCase(unittest.TestCase):
    ...
    @patch("yule_discord.conversation.generate_ollama_text")
    @patch("yule_discord.conversation.load_ollama_conversation_config")
    @patch("yule_discord.conversation.load_plan_today_snapshot")
    ...
    @patch("yule_discord.conversation.load_ollama_conversation_config")
    @patch("yule_discord.conversation.load_plan_today_snapshot")
    @patch("yule_discord.conversation.build_due_checkpoints")
    ...
    @patch("yule_discord.conversation.save_json_cache")
    @patch("yule_discord.conversation.load_ollama_conversation_config")
    @patch("yule_discord.conversation.load_plan_today_snapshot")
    ...
    @patch("yule_discord.conversation.clear_checkpoint_pending_response")
    @patch("yule_discord.conversation.mark_checkpoint_responded")
    @patch("yule_discord.conversation.load_checkpoint_pending_response")
