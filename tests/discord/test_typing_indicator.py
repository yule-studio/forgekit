...
from yule_orchestrator.discord.ui.typing_indicator import safe_typing, typing_context
...
class MemberBotTypingIntegrationTests(unittest.TestCase):
    ...
    def test_post_runs_inside_typing(self) -> None:
        ...
        from yule_orchestrator.discord.ui.typing_indicator import typing_context
