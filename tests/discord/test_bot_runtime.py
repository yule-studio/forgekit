...
from yule_discord.runtime.planning import (
...
class DiscordBotRuntimeTestCase(unittest.TestCase):
    ...
    @patch("yule_discord.runtime.planning.load_daily_plan_snapshot")
    ...
    @patch("yule_discord.bot.scheduling.build_due_checkpoints")
    @patch("yule_discord.bot.scheduling.load_prefetched_due_checkpoints")
    ...
    @patch("yule_discord.runtime.planning.build_daily_checkpoints_for_date")
...
class EngineeringConversationBridgeTestCase(unittest.TestCase):
    @patch(
        "yule_discord.engineering_conversation."
