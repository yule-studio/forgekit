...
from yule_discord.member.bot import _dispatch_member_message
from yule_discord.member.bots import MemberBotProfile
...
class ResearchTurnDispatchTests(unittest.TestCase):
    def test_outcome_present_posts_research_turn(self) -> None:
        ...
        with patch(
            "yule_discord.member.bot.handle_research_turn_message",
            return_value=sentinel,
        ), patch(
            "yule_discord.member.bot._post_research_turn",
    ...
    def test_inactive_role_returns_none_stays_silent(self) -> None:
        ...
        with patch(
            ...
            "yule_discord.member.bot.handle_team_turn_message",
            return_value=None,
        ), patch(
            "yule_discord.member.bot._post_research_turn",
            side_effect=fake_post,
...
class TeamTurnDispatchTests(unittest.TestCase):
    def test_team_turn_outcome_posts(self) -> None:
        ...
        with patch(
            ...
            "yule_discord.member.bot._post_team_turn",
            side_effect=fake_post,
        ):
            _run(lambda: _dispatch_member_message(
                profile=_profile(), message=message
