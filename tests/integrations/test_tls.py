...
from yule_core.tls import apply_ca_bundle_fallback, resolve_ca_bundle
...
class TLSBundleTestCase(unittest.TestCase):
    ...
    @patch("yule_core.tls._load_certifi_cafile")
    @patch("yule_core.tls.ssl.get_default_verify_paths")
