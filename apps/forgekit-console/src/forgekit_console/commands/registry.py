...
_COMMANDS: Tuple[SlashCommand, ...] = (
    ...
    SlashCommand("resolve", "Hephaistos — 요청을 skill/loadout/weapon/source/packet 으로 resolve (`/resolve <요청>`); governance 실행·기록 `/resolve apply <요청>`, 기록 조회 `/resolve log`", H_RESOLVE, "status"),
