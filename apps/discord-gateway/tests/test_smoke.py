...
``yule_orchestrator.discord`` path still resolves to the SAME module objects via
...
def test_legacy_path_aliases_same_objects() -> None:
    ...
    from yule_orchestrator.discord.ui import formatter as old_formatter
...
def test_top_package_aliases_same_object() -> None:
    import yule_orchestrator.discord as old_pkg
...
def test_shim_subpackages_still_point_at_agents() -> None:
    ...
    # already thin shims re-exporting ``yule_orchestrator.agents.*``; they moved
    ...
    from yule_orchestrator.agents import engineering_team_runtime as agents_etr
    ...
    from yule_orchestrator.discord.research_forum import (  # noqa: F401
