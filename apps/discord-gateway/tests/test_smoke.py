...
``yule_engineering.discord`` path still resolves to the SAME module objects via
...
def test_legacy_path_aliases_same_objects() -> None:
    ...
    from yule_engineering.discord.ui import formatter as old_formatter
...
def test_top_package_aliases_same_object() -> None:
    import yule_engineering.discord as old_pkg
...
def test_shim_subpackages_still_point_at_agents() -> None:
    ...
    from yule_engineering.discord.research_forum import (  # noqa: F401
