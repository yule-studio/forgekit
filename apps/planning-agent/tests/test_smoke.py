...
``yule_orchestrator.planning`` path still resolves to the SAME objects via the
compatibility shims.
"""
...
def test_legacy_path_aliases_same_objects() -> None:
    from yule_orchestrator.planning import build_daily_plan, DailyPlan
    from yule_orchestrator.planning import models, planner
