...
def _related_files(problem: ProblemObject) -> list:
    ...
    candidates = {
        "engineering_write_reply_mismatch": [
            ...
            "apps/engineering-agent/src/yule_engineering/agents/job_queue/approval_reply.py",
        ],
        "approval_no_matching_reply": [
            "apps/engineering-agent/src/yule_engineering/discord/approval/reply_router.py",
            "apps/engineering-agent/src/yule_engineering/agents/job_queue/approval_worker.py",
        ],
        "qa_test_misclassification": [
            "apps/engineering-agent/src/yule_engineering/discord/engineering_channel_router/main.py",
            "apps/engineering-agent/src/yule_engineering/agents/routing.py",
        ],
        "coding_continuation_stalled": [
            "apps/engineering-agent/src/yule_engineering/agents/job_queue/work_order_coding_continuation.py",
            "apps/engineering-agent/src/yule_engineering/agents/job_queue/coding_execute_dispatcher.py",
        ],
        "supervisor_watch_unknown_surface": [
            "apps/engineering-agent/src/yule_engineering/runtime/status.py",
            "apps/engineering-agent/src/yule_engineering/runtime/status_poster.py",
        ],
        ...
        "member_bot_presence_confusion": [
            "apps/engineering-agent/src/yule_engineering/discord/member/bot.py",
        ],
        "issueless_bootstrap_failure": [
            "apps/engineering-agent/src/yule_engineering/agents/job_queue/github_work_order.py",
        ],
    }
