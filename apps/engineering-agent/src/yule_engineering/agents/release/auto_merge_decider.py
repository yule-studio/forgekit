...
_HIGH_RISK_MODULE_PREFIXES: Tuple[str, ...] = (
    "apps/engineering-agent/src/yule_engineering/agents/security/",
    "apps/engineering-agent/src/yule_engineering/agents/safety/",
    "policies/runtime/agents/engineering-agent/issue-pr-conventions",
)


_LIVE_LLM_MODULE_PREFIXES: Tuple[str, ...] = (
    "apps/engineering-agent/src/yule_engineering/agents/job_queue/coding_executor_live",
    "apps/engineering-agent/src/yule_engineering/agents/job_queue/claude_subprocess_adapter",
)
